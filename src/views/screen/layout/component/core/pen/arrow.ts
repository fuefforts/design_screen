import { calcRotate, type Point } from '../point'
import type { Meta2dStore } from '../store'
import type { Pen } from './model'
import { getFromAnchor, getToAnchor } from './render'

const arrows: Record<
  string,
  (ctx: CanvasRenderingContext2D, pen: Pen, store: Meta2dStore, point: Point) => void
> = {}

export function renderFromArrow(ctx: CanvasRenderingContext2D, pen: Pen, store: Meta2dStore) {
...
export function renderToArrow(ctx: CanvasRenderingContext2D, pen: Pen, store: Meta2dStore) {
...
arrows.triangle = (ctx: CanvasRenderingContext2D, pen: Pen, store: Meta2dStore, point: Point) => {
  ctx.save()
  if (ctx.lineWidth < 2) {
    ctx.lineWidth = 2
  }
...
arrows.circle = (ctx: CanvasRenderingContext2D, pen: Pen, store: Meta2dStore, point: Point) => {
  ctx.save()
  ctx.translate(point.x, point.y)
  ctx.rotate((point.rotate * Math.PI) / 180)
  ctx.translate(-point.x, -point.y)
...
arrows.diamond = (ctx: CanvasRenderingContext2D, pen: Pen, store: Meta2dStore, point: Point) => {
  ctx.save()
  ctx.translate(point.x, point.y)
  ctx.rotate((point.rotate * Math.PI) / 180)
  ctx.translate(-point.x, -point.y)
...
arrows.line = (ctx: CanvasRenderingContext2D, pen: Pen, store: Meta2dStore, point: Point) => {
  ctx.save()
  ctx.translate(point.x, point.y)
  ctx.rotate((point.rotate * Math.PI) / 180)
  ctx.translate(-point.x, -point.y)
...
arrows.lineUp = (ctx: CanvasRenderingContext2D, pen: Pen, store: Meta2dStore, point: Point) => {
  ctx.save()
  ctx.translate(point.x, point.y)
  ctx.rotate((point.rotate * Math.PI) / 180)
  ctx.translate(-point.x, -point.y)
...
arrows.lineDown = (ctx: CanvasRenderingContext2D, pen: Pen, store: Meta2dStore, point: Point) => {
  ctx.save()
  ctx.translate(point.x, point.y)
  ctx.rotate((point.rotate * Math.PI) / 180)
  ctx.translate(-point.x, -point.y)
